...
<body>
  ...
  <div id="sideBar" class="sideBar bg-success">
    <ul>
      ...
      <li><a href="admin_private.php?a=posts" class="_tool"><i class="fas fa-file-alt fa-fw mr-3 mt-1"></i> <span>Posts</span></a><span class="_tip">Posts</span></li>
      <li><a href="admin_private.php?a=categories" class="_tool"><i class="fas fa-folder-plus fa-fw mr-3 mt-1"></i> <span>Categories</span></a><span class="_tip">Categories</span></li>
      <li><a href="admin_private.php?a=admins" class="_tool"><i class="fas fa-users fa-fw mr-3 mt-1"></i> <span>Admins</span></a><span class="_tip">Admins</span></li>
      <li><a href="admin_private.php?a=comments" class="_tool"><i class="fas fa-comments fa-fw mr-3 mt-1"></i> <span>Comments</span></a><span class="_tip">Comments</span></li>
      <hr>
      <li><a href="blog.php?page=1" class="_tool"><i class="fas fa-book fa-fw mr-3 mt-1"></i> <span>LiveBlog</span></a><span class="_tip">LiveBlog</span></li>
