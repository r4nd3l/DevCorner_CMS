...
$(function(){
  $('#pie').rotapie({
    slices: [
      { color: '#ffc107', percentage: _posts }, // oranage // If color not set, slice will be transparant.
      { color: '#28a745', percentage: _categories }, // green // Font color to render percentage defaults to 'color' but can be overriden by setting 'fontColor'.
      { color: '#dc3545', percentage: _admins }, // purple
      { color: '#17a2b8', percentage: _comments } // blue
    ],
    ...
    fontFamily: 'Roboto', // FontFamily percentage display.
